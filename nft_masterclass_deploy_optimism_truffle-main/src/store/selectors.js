...
const contractLoaded= state => get(state, 'contract.contract_loaded', false)
export const contractLoadedSelector = createSelector(contractLoaded, l => l)

const metadataLoaded= state => get(state, 'contract.metaData_loaded', false)
export const metadataLoadedSelector = createSelector(metadataLoaded, l => l)

const nftStateLoaded = state => get(state, 'contract.nftState_loaded', false)
